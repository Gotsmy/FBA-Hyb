...
def get_FBA_data(col_inp, col_out):
    FBAdata = pd.read_csv("/mnt/y/code/250513_metabolic_process_models/prol_fba_data/01_obj_fba_data.csv",index_col=0)
...
if __name__ == "__main__":
    ...
    model = pysr.PySRRegressor(
                ...
                populations=200,
                population_size=200,
                output_directory="/mnt/y/code/250513_metabolic_process_models/prol_fba_data/sr_models",
