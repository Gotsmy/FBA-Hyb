...
class HYB(eqx.Module):
    ...
    def __init__(self, 
        ...
        self.SCL_yy = SCL_yy
        self.SCL_uu = SCL_uu
        self.SCL_mod_ann_inp = !!MOD_ANN_INP_SCALER
...
def get_model_config(verbose=True):
    ...
    modify_ann_inp = "none"
    # True or false
    extra_metabolites = !!do_extra_metabolites
...
if __name__ == "__main__":
    ...
    for nr, valid_set in enumerate(cross_valid_sets):
        ...
        ALL_data = preprocess_data(exp_dataframes,aug_dataframes,valid_set,scalers,augmented=!!AUGMENT)
