...
def get_exp_dfs():
    exp_onl = pd.read_csv("./slim_process_data/250818_exp_onl.csv",index_col=0)
    exp_off = pd.read_csv("./slim_process_data/250818_exp_off.csv",index_col=0)
    exp_dsp = pd.read_csv("./slim_process_data/250818_exp_dsp.csv",index_col=0)

    return exp_off,exp_onl,exp_dsp

def get_aug_dfs():
    aug_onl = pd.read_csv("./slim_process_data/250818_aug_onl.csv",index_col=0)
    aug_off = pd.read_csv("./slim_process_data/250818_aug_off.csv",index_col=0)
    aug_dsp = pd.read_csv("./slim_process_data/250818_aug_dsp.csv",index_col=0)
...
if __name__ == "__main__":
    ...
    save_path = "/mnt/y/code/250513_metabolic_process_models/slim_model_data/"+__file__.split("/")[-1].replace(".py","")+"/"
