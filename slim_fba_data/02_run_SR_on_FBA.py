...
def get_scalers(col_inp, col_out):
    SCL_inp = DF.SCL_init_from_slim_fba(col_inp,method="mean") 
    SCL_out = DF.SCL_init_from_slim_fba(col_out,method="mean")
...
def get_columns_inp_out():
    ...
    # output columns
    COL_out = np.array(["EX_glc__D_e","pDNA_synthesis",'BIOMASS_Ec_iML1515_core_75p37M',"ATPM",
                        'EX_co2_e','EX_nh4_e','EX_o2_e','EX_so4_e',])
